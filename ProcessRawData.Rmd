...
The total series spread id `r seriesSpread` and the baseline anomaly for the years `r syear` through `r eyear` inclusive is `r baseline` with a spread of `r basespread`
